...
CREATE TABLE movie_genre(id INTEGER PRIMARY KEY ASC, movie_id INTEGER NOT NULL, genre_id NOT NULL, added_at TEXT DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE user_rating(id INTEGER PRIMARY KEY ASC, user_id INTEGER NOT NULL, movie_id INTEGER, rating INTEGER NOT NULL, added_at TEXT DEFAULT CURRENT_TIMESTAMP);
...
CREATE TABLE user_favourite(id INTEGER PRIMARY KEY ASC, user_id INTEGER NOT NULL, movie_id INTEGER NOT NULL, added_at TEXT DEFAULT CURRENT_TIMESTAMP);
